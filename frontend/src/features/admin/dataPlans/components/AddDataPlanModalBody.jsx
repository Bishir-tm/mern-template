...
function AddDataPlanModalBody({ closeModal }) {
  ...
  const [dataPlan, setDataPlan] = useState({
    ...
    plan_id: "",
    networkId: "",
    dataType: "", // Changed to `dataType` for consistency
  });
  ...
  const saveDataPlan = () => {
    ...
    setLoading(true);
    dispatch(createDataPlan(dataPlan))
      .unwrap()
      .then(() => {
      ...
      .catch(() => {
        setErrorMessage("Failed to create data plan. Please try again.");
      })
      .finally(() => {
        setLoading(false);
      });
...
export default AddDataPlanModalBody;
